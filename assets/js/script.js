...
//   // Adds id to task object, then puts the task object into the array
//   taskDataObj.id = taskIdCounter;
//   tasks.push(taskDataObj);
...
//   // loop through tasks array and task object with updated content
//   for (var i = 0; i < tasks.length; i++) {
//     // id task ID's are the same, take the info from the form and save in the object
//     if(tasks[i].id === parseInt(taskId)) {
//       tasks[i].name = taskName;
//       tasks[i].type = taskType;
//     }
...
//   // saves to local storage and confirms to user
//   saveTasks();
//   alert("Task Updated!");
...
//   // create a temporary array to hold the saved tasks
//   var updatedTaskArr = [];

//   // loop through current tasks
//   for (var i = 0; i < tasks.length; i++) {
//     // if tasks[i].id doesnt match the value of taskId, push into new array
...
//   // updates task's status in array
//   for (var i = 0; i < tasks.length; i++) {
//     if (tasks[i].id === parseInt(taskId)) {
//       tasks[i].status = statusValue;
//     }
